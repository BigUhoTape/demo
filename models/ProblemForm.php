 ...
 */
class ProblemForm extends Problem
{

    public $photoBeforeForm;
    ...
    {
        return [
            [['name', 'description', 'idCategory', 'photoBefore', 'photoBeforeForm'], 'required'],
            [['description', 'status'], 'string'],
            [['timestamp'], 'safe'],
            [['idUser', 'idCategory'], 'integer'],
            ['photoBeforeForm', 'file', 'skipOnEmpty' => false, 'extensions' => 'png, jpg, jpeg, bmp', 'maxSize' => 10*1024*1024],
